...
export const metadata = {
  ...
  description: "Perfiles premium en Montevideo. Proximamente en VIAVIP.",
};
...
export default function MVDPage() {
  return (
    <main>
      ...
      <div className="vv-zone-empty" data-testid="mvd-empty-state">
        ...
        <h1 className="vv-zone-empty-title" data-testid="text-zone-title">Montevideo</h1>
